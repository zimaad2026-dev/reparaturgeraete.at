...
export const metadata: Metadata = {
  title: "Über uns",
  description:
    "GeräteProfi – Ihr Partner für Reparaturen von Haushaltsgeräten in Österreich. Erfahrene Techniker, faire Preise, schneller Service. Erfahren Sie mehr über uns.",
};
      ...
      <section className="border-b border-slate-200 bg-white">
        <div className="mx-auto max-w-6xl px-4 pb-12 pt-10 md:px-6 md:pb-16 md:pt-14 lg:px-8">
          ...
          <p className="mt-4 max-w-2xl text-base leading-relaxed text-slate-600 sm:text-lg">
            ...
            Haushaltsgeräten in Österreich. Wir kommen zu Ihnen – mit erfahrenen
